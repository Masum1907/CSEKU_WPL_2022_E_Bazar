    ...
    <form style="padding-top:30px;padding-bottom:130px;"action=""method="post"enctype="multipart/form-data"style="margin-top:45px";>
...
echo "<option value='$cat_id'>$cat_title</option>";
            ...
            <tr  align="center">
                ...
                <td  style="padding:10px"colspan="2"><input type="submit"name="insert" value="Insert Pro"></td>
            </tr>
...
$id=$_SESSION['vendor_id'];
    ...
    $dest='C:\xampp\htdocs\e_bazar\admin_area\product_images/';
    $dest2='C:\xampp\htdocs\e_bazar\vendor_area\product-images/';
    $product_image_tmp=$_FILES['product_image']['tmp_name'];

move_uploaded_file($product_image_tmp,$dest.$product_image);
chmod($dest.$product_image,0777);    
 
    copy($dest.$product_image, $dest2.$product_image);

$insert_product="insert into products (product_cat,product_title,product_price,product_desc,product_image,product_keywords,vendor_id)
values('$product_cat','$product_title',' $product_price','$product_desc','$product_image','$product_keywords','$id')";
